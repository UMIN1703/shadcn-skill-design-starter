...
export const SubscriptionDate: Story = {
  render: () => <SubscriptionDatePicker />,
};

export const WithTime: Story = { render: () => <DateWithTime /> };

export const WithPreset: Story = { render: () => <DateWithPreset /> };

export const InForm: Story = { render: () => <DateInForm /> };

export const OpenInteraction: Story = {
  name: "Open calendar (QA test)",
