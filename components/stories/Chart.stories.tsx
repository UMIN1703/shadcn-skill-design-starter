...
function AreaChartExample() {
  return (
    <ChartContainer config={areaConfig} className="h-[260px] w-full max-w-2xl">
...
function PieChartExample() {
  return (
    <ChartContainer config={pieConfig} className="h-[260px] w-full max-w-2xl">
      <PieChart>
...
const meta: Meta<typeof InteractiveBarChart> = {
  title: "UI/Chart",
...
type Story = StoryObj<typeof InteractiveBarChart>;

export const Default: Story = {};

export const BarInteractive: Story = { render: () => <InteractiveBarChart /> };
